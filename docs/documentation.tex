...
\begin{example}
The \term{term style} is defined in \verb|\term|.
\end{example}
...
\begin{example}
The style for \readas{"this text"} is accessed with \verb|\readas|.
\end{example}

\chapter{Pseudolanguage}
Code examples are written in a \term{pseudolanguage} which is a mix of Kotlin, Python and C.
